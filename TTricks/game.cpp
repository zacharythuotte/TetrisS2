...
Game ::Game() : QFrame()
{
	//initialisations
    srand(time(NULL));
    curForme = new Forme(rand() % FORMEZ + 1);
    prochaineForme = new Forme(rand() % FORMEZ + 1);
    curForme->setX(4);
    curForme->setY(2);
...
void Game::paintEvent(QPaintEvent *)
{
	...
	QRgb TableCouleur[7] = {0xff66ff, 0x66ff33, 0xff0000, 0x0000ff, 0xffff00, 0x00ffff,0xffffff};
